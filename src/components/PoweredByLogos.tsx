...
/**
 * If your footer is fixed (e.g., `fixed bottom-0`), its height can overlap content.
 * We add bottom padding equal to that height + safe-area, using `--footer-height`.
 * If your footer sets this CSS var globally, we’ll use it. Otherwise we default to 64px.
 *
 * Example footer style to pair with this component:
 * <footer className="fixed bottom-0 left-0 right-0 h-16" style={{ ['--footer-height' as any]:'64px' }} />
 */
