      ...
      >
        <div className="flex gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {displayCast.embeds.length > 0 && (() => {
              const imageEmbed = displayCast.embeds.find(e => e?.url?.match(/\.(jpg|jpeg|png|gif|webp)$/i));
              const videoEmbed = displayCast.embeds.find(e => e?.url?.match(/\.(mp4|webm|mov)$/i));
