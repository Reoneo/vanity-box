                        ...
                        <div className="relative">
                          <div className="absolute left-1 top-1 z-10 flex items-center h-10">
                            <DropdownMenu open={showFilterDropdown} onOpenChange={setShowFilterDropdown}>
                              ...
                              <DropdownMenuContent
                                align="start"
                                className="w-72 md:w-80 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border-2 border-[#D4AF37]/30 rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.6)] p-4 z-[80]"
                              >
                                <div className="relative">
                    ...
                    {!web3BioProfile && (
                      <div className="mt-2">
                        {isLoading ? (
                          ...
                          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-2">
                            <span className="text-[#D4AF37]">{ensResults.length} ID's</span>
                          </h1>
                        ) : null}
                      </div>
                    )}
