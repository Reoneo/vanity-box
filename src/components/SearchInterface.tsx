                  ...
                  <CardContent className="p-4 md:p-6">
                    <div className="space-y-4 md:space-y-6">
                      ...
                      <div className="space-y-3 md:space-y-4">
                        <div className="group flex gap-4 md:gap-5 p-3 md:p-4 rounded-xl hover:bg-[#D4AF37]/5 transition-all duration-300">
                      ...
                      <div className="mt-6 md:mt-8 flex justify-center">
                        <a
                          ...
                          className="px-8 py-3 md:px-10 md:py-4 bg-gradient-to-r from-[#D4AF37] via-[#F4E4B7] to-[#D4AF37] text-black font-bold rounded-xl transition-all duration-300 hover:scale-105 shadow-[0_8px_30px_rgba(212,175,55,0.3)] hover:shadow-[0_12px_40px_rgba(212,175,55,0.5)] text-sm md:text-base"
                        >
                          Learn More
                        </a>
                      </div>
