        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-3 text-foreground/80">
              <li>
                This Privacy Policy (the "<strong>Policy</strong>") sets out how Vanity.box and any of our
                subcontractors operating the Vanity.box websites ("<strong>Vanity.box</strong>", "<strong>we</strong>",
                "<strong>our</strong>" or "<strong>us</strong>") and applications which refer to this Policy, may
                collect, use, disclose or otherwise process your Personal Data (as defined below). In this Policy,
                Vanity.box websites' domain names include but are not limited to https://vanity.box/.
              </li>
              <li>
                This Policy applies to Personal Data in our possession or under our control, including Personal Data in
                the possession of organisations or persons that we have engaged to collect, use, disclose or process
                personal data for our purposes. By continuing to browse our website and use our services, you consent to
                our collection, use and disclosure of your Personal Data in accordance with the terms listed in this
                Policy.
              </li>
              <li>Please read this Policy carefully to understand how we will treat your Personal Data.</li>
              <li>
                In this Policy, "<strong>Personal Data</strong>" means data, whether true or not, about you who can be
                identified: (a) from that data; or (b) from that data and other information to which we have or are
                likely to have access.
              </li>
              <li>
                This Policy applies in conjunction with any other notices, contractual clauses and consent clauses that
                apply in relation to the collection, use and disclosure of your Personal Data by us.
              </li>
              <li>
                If you have any comments on, or questions about this Policy, please email them to our data protection
                officer at r@vanity.box.
              </li>
            </ol>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-playfair font-semibold mb-4">
              02. What Personal Data We May Collect About You
            </h2>
            <ol className="list-decimal list-inside space-y-3 text-foreground/80">
              <li>
                We may collect Personal Data about you when you use our website, applications, or services. The types of
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-3 text-foreground/80">
              ...
              <li>
                Blockchain data, by its nature, is publicly accessible and immutable. Please be aware that any
                transactions and domain registrations on the blockchain are permanent and publicly visible.
              </li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-3 text-foreground/80">
              <li>
                We may use third-party service providers to help us operate our website and provide our services. These
                providers may have access to your Personal Data only to perform specific tasks on our behalf and are
